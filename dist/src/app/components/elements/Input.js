...
function Input(props) {
    ...
    //   {children}
    // </button>
    (0, jsx_runtime_1.jsxs)("label", { className: `flex gap-2 description border text-color-1 dark:border-dark dark:text-color-1-dark font-semibold py-[.438rem] px-4 rounded-lg hover:scale-[1.01] duration-150 ${className}`, ...rest, children: [icon, (0, jsx_runtime_1.jsx)("input", { onChange: onChange, value: value || '', className: 'description text-color-1 dark:text-color-1-dark bg-transparent outline-0 w-full h-full', ...rest })] }));
}
