...
import NotificationsItem from "../components/elements/NotificationsItem";
    ...
    return (
        ...
        <NotificationContext.Provider value={contextValue}>
            <DispatchNotificationContext.Provider value={push}>
                ...
                <section className='z-[999] w-full h-full flex absolute pointer-events-none overflow-hidden'>

                    <div className='relative flex flex-col ml-auto p-3'>

                        { list?.map(item =>  <NotificationsItem key={item._id} notification={item} onClose={()=> removeItem(item._id || -1)} />) }
